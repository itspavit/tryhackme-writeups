...
1. **`c4n y0u c4p7u23 7h3 f149?`**
   - **Solution**: Observe the text carefully

2. **`01101100 01100101 01110100 01110011 00100000 01110100 01110010 01111001 00100000 01110011 01101111 01101101 01100101 00100000 01100010 01101001 01101110 01100001 01110010 01111001 00100000 01101111 01110101 01110100 00100001`**
   - **Solution**: Convert binary to text using CyberChef 

3. **`MJQXGZJTGIQGS4ZAON2XAZLSEBRW63LNN5XCA2LOEBBVIRRHOM======`**
   - **Solution**: Convert from Base32 using CyberChef 

4. **`RWFjaCBCYXNlNjQgZGlnaXQgcmVwcmVzZW50cyBleGFjdGx5IDYgYml0cyBvZiBkYXRhLg==`**
   - **Solution**: Convert from Base64 using CyberChef 

5. **`68 65 78 61 64 65 63 69 6d 61 6c 20 6f 72 20 62 61 73 65 31 36 3f`**
   - **Solution**: Convert hex to text using CyberChef 

6. **`Ebgngr zr 13 cynprf!`**
   - **Solution**: Use ROT13 in CyberChef 

7. **`*@F DA:? >6 C:89E C@F?5 323J C:89E C@F?5 Wcf E:>6DX`**
   - **Solution**: Use ROT47 in CyberChef

8. **`- . .-.. . -.-. --- -- -- ..- -. .. -.-. .- - .. --- -. . -. -.-. --- -.. .. -. --.`**
   - **Solution**: Convert from Morse code using CyberChef 

9. **`85 110 112 97 99 107 32 116 104 105 115 32 66 67 68`**
   - **Solution**: Convert from decimal to text using CyberChef
...
then convert the above from morse code you will get 
...
1. **Hidden Message in File**  
   ...
   - **Solution**: Use a spectrogram creator (e.g., [Spectrogram Creator](https://convert.ing-now.com/audio-spectrogram-creator/)) to analyze the file. This reveals the message
...
1. **Hidden Message in Image**  
   ...
   - **Solution**: Use a steganography decoder like [FutureBoy Steganography Decoder](https://futureboy.us/stegano/) and upload the image.
---
...
1. **Identifying First File in Archive**  
   ...
   - **Solution**: Open the file in a text editor (such as Neovim or Notepad) that displays ASCII characters. At the bottom of the text, you’ll find the answer

2. **Extracting Hidden Text**  
   - **Challenge**: Further inspect the archive for hidden text.
   - **Solution**: Continue examining the file in a text editor to locate the hidden message at the bottom
